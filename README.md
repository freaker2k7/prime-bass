...
So I created this simple web app that generates a given amount of prime numbers and plays them as a sequence of notes.<br>
You can adjust the number of notes, note duration, and the number of primes to generate.<br>
<br>
